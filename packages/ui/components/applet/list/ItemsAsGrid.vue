  ...
  methods: {
    ...
    async getRows() {
      try {
        ...
        const filterSpecs = this.appletView.filter;
        const searchKeys = this.appletViewSearchKeys;
        const dataFilteringQrySpec = this.$api.dataFilteringQrySpec(filterSpecs, { keys: searchKeys, text: this.searchText });
